...
<button
  ...
  <div 
    className="fixed bottom-[calc(4rem+1.5rem)] right-0 mr-4 bg-white p-6 rounded-lg border border-[#e5e7eb] w-[440px] h-[634px] shadow-2xl">
    ...
    <div className="pr-4 h-[474px] min-w-full" >
      ...
      <div className="flex gap-3 my-4 text-gray-600 text-sm flex-1"><span
        ...
        <p className="leading-relaxed"><span className="block font-bold text-gray-700">AI </span>Sorry, I couldnt find any
